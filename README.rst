...
`Release Notes <https://docs.djangoproject.com/en/dev/releases/4.1/#features-deprecated-in-4-1>`__

``django.utils.timezone.utc``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Replace deprecated ``django.utils.timezone.utc`` alias by ``datetime.timezone.utc``:
